  ...
  return (
    <div className="p-8 max-w-3xl">
      <div className="flex items-center gap-4 mb-8">
        ...
        <h1 className="text-2xl font-bold" style={{ color: 'var(--navy)', fontFamily: 'Montserrat, sans-serif' }}>상품 등록</h1>
      </div>
      ...
      <form onSubmit={handleSubmit}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
          ...
          <div className="bg-white border p-6" style={{ borderColor: '#E8E4DD', borderRadius: 8 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 12 }}>
              ...
              <div>
                ...
                <input type="number" placeholder="0"
                  value={form.sale_price} onChange={e => handleChange('sale_price', e.target.value)}
                  style={inputStyle} />
              </div>
          ...
          <div className="bg-white border p-6" style={{ borderColor: '#E8E4DD', borderRadius: 8 }}>
            ...
            <textarea placeholder="상품 상세 설명을 입력해주세요. (HTML 태그 사용 가능)"
              value={form.content} onChange={e => handleChange('content', e.target.value)}
              rows={10} style={{ ...inputStyle, resize: 'vertical' }} />
            <p style={{ fontSize: 12, color: '#8a9099', marginTop: 8, fontFamily: PRETENDARD }}>
            ...
            {accordions.map(a => (
              <div key={a.key} style={{ borderBottom: '1px solid #E8E4DD' }}>
                <button type="button"
                  ...
                  {a.label}
                  <span style={{ fontSize: 18, color: '#8a9099', transition: 'transform 0.2s', transform: accordionOpen[a.key] ? 'rotate(180deg)' : 'rotate(0deg)' }}>›</span>
                </button>
                {accordionOpen[a.key] && (
                  <div style={{ padding: '0 24px 16px' }}>
                    <textarea
                      value={form[a.key as keyof typeof form] as string}
