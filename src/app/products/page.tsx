...
const PRODUCTS = [
  {
    ...
    sub: '10 × 3ml',
    tag: 'FLAGSHIP',
    desc: '60가지 활성 성분 복합체. 피부 세포 재생·수분·탄력 동시 개선.',
    specs: ['60 active ingredients + Free HA', '10×3ml 바이알', 'CE Marked · Fillmed 정품'],
  ...
  },
  {
    ...
    specs: ['Stylage S — 잔주름 (16 mg/ml)', 'Stylage M — 팔자·마리오네트 (20 mg/ml)', 'Stylage L — 볼륨 복원 (24 mg/ml)', 'Stylage XL — 심층 볼륨 복원 (26 mg/ml)'],
